...
Credits.Text = "Edge // Zwolf // Moon // Toon (relevant500 for the decompiler, not mine again)"
...
addcmd('explorer', {'dex'}, function(args, speaker)
	notify('Loading', 'Hold on a sec')
	loadstring(game:HttpGet('https://raw.githubusercontent.com/Guilded1/decompilerdex/main/dex.lua'))()
end)
